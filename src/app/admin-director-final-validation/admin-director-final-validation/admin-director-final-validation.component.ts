...
@Component({
  selector: 'app-admin-dean-final-validation',
  templateUrl: './admin-director-final-validation.component.html',
  styleUrls: ['./admin-director-final-validation.component.css']
})
export class AdminDirectorFinalValidationComponent implements OnInit{
  isDirector=false;
  isSuperAdmin=false;
  ...
  getWish(){
      this.wishService.wishGetAllStatusResultsDirector().subscribe((results)=>{
        this.wish=results;
      });
  }
