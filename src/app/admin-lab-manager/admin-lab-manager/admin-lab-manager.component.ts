...
@Component({
  selector: 'app-admin-lab-manager',
  templateUrl: './admin-lab-manager.component.html',
  styleUrls: ['./admin-lab-manager.component.css']
})
export class AdminLabManagerComponent implements OnInit{
  isLab=false;
  isSuperAdmin=false;
  ...
  getWish(){
      this.wishService.wishGetAllStatusResultsExemption().subscribe((results)=>{
        this.wish=results;
      });
  }
