...
@Component({
  selector: 'app-admin-post-competition',
  templateUrl: './admin-post-competition.component.html',
  styleUrls: ['./admin-post-competition.component.css']
})
export class AdminPostCompetitionComponent implements OnInit{
  isCommittee=false;
  ...
  getWish(){
      this.wishService.wishGetAllStatusResults().subscribe((results)=>{
        this.wish=results;
      });
  }
